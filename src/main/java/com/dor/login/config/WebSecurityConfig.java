...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity httpSecurity) throws Exception {
		...
		httpSecurity.cors().and().csrf().disable()
				...
				.authorizeRequests().antMatchers("/api/v1/login/generate/otp","/api/v1/user/login","/api/v1/forget/password/generate/otp",
						...
						"/api/v1/authenticated/user/list/day","/api/v1/authenticated/user/list/month","/api/v1/authenticated/user/list/year").permitAll().
